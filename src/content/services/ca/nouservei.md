...
lang: ca
title: nouServei
shortDescription: nouServei Tractament de fisioteràpia professional al teu
  domicili per a persones amb dificultat de desplaçament.
description: NouServei descripció Si no pots apropar-te al nostre centre,
  nosaltres ens desplacem a casa teva! Aquest servei sofereix a les persones que
  tenen dificultat per desplaçar-se o que prefereixen rebre el tractament al seu
  entorn familiar. Aquesta modalitat és especialment beneficiosa per persones
...
process:
  - step: primer
    description: primer pas
  - step: segon
    description: segon pas
duration: 30 minuts
price: 30€
order: 3
faqs:
  - question: fa mal?
    answer: Nooooo **NOOOOO**
  - question: Segur que no fa mal??
    answer: "***SEGURISSIM***"
gallery:
